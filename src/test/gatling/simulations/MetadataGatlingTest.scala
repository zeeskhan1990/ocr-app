...
class MetadataGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Metadata entity")
        ...
        .repeat(2) {
            ...
            .post("/api/metadata")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "originalValue":"SAMPLE_TEXT", "verifiedValue":"SAMPLE_TEXT", "creationDate":"2020-01-01T00:00:00.000Z", "createdBy":"SAMPLE_TEXT", "updationDate":"2020-01-01T00:00:00.000Z", "updatedBy":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
